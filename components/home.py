...
def Sidebar(c:DeltaGenerator):
    ...
    c.link_button("Go to Home page &#8599;", "/")
    c.link_button("Go to About page &#8599;", "/about")
    c.link_button("Go to Personalize &#8599;", "/personalize")
    c.link_button("Go to Culture page &#8599;", "/culture")
    c.link_button("Go to Explore page &#8599;", "/explore")
