...
def Answers() -> list[str]:
    return [
        ...
        """Yes! If you’re interested in contributing, feel free to reach out or check out the [GitHub repo](https://github.com/MementoMori11723/Hephaestus.git). Contributions, ideas, and feedback are always welcome.""",
